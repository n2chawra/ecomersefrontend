  ...
  return async (dispatch) => {
    ...
    try {
      if (AuthUtil.isLoggedIn()) {
        ...
        let dataUrl = `https://react-cart-backend.onrender.com/api/products/upload`;
...
export const getMensProducts = () => {
  return async (dispatch) => {
    ...
    try {
      let dataUrl = `https://react-cart-backend.onrender.com/api/products/men`;
...
export const getWomensProducts = () => {
  return async (dispatch) => {
    ...
    try {
      let dataUrl = `https://react-cart-backend.onrender.com/api/products/women`;
      let res = await axios.get(dataUrl);
      dispatch({
...
export const getKidsProducts = () => {
  return async (dispatch) => {
    ...
    try {
      let dataUrl = `https://react-cart-backend.onrender.com/api/products/kids`;
      let res = await axios.get(dataUrl);
...
export const getSingleProduct = (id) => {
  return async (dispatch) => {
    ...
    try {
      let dataUrl = `https://react-cart-backend.onrender.com/api/products/${id}`;
      let res = await axios.get(dataUrl);
      dispatch({
