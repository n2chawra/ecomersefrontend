...
export const registerUser = (user, navigate) => {
  return async (dispatch) => {
    ...
    try {
      let dataUrl = `https://react-cart-backend.onrender.com/api/users/register`;
...
export const loginUser = (user, navigate) => {
  return async (dispatch) => {
    ...
    try {
      let dataUrl = `https://react-cart-backend.onrender.com/api/users/login`;
      let res = await axios.post(dataUrl, user);
  ...
  return async (dispatch) => {
    ...
    try {
      if (AuthUtil.isLoggedIn()) {
        ...
        let dataUrl = `https://react-cart-backend.onrender.com/api/users/`;
  ...
  return async (dispatch) => {
    ...
    try {
      if (AuthUtil.isLoggedIn()) {
        let token = AuthUtil.getToken();
        TokenUtil.setToken(token);
        let dataUrl = `https://react-cart-backend.onrender.com/api/users/address`;
